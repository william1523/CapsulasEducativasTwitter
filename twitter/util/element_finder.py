...
class Finder:
    ...
    @staticmethod
    def find_view(tweet) -> Union[int, str]:
        """finds shares from the tweet"""
        try:
            shares_element = tweet.find_element(
    ...
    def find_status(tweet) -> Union[list, tuple]:
        ...
        try:
            ...
            for anchor in anchors:
                ...
                if "status" in anchor.get_attribute("href"):
                    return (anchor.get_attribute("href").split("/"), anchor.get_attribute("href"))
            return ("https://twitter.com/Mattheu64/status/1670345699140030466".split("/"),"https://twitter.com/Mattheu64/status/1670345699140030466")
    ...
    @staticmethod
    def find_is_advertising(tweet) -> Union[str, None]:
        """finds profile image links
        ...
        Returns:
            Union[str, None]: returns string containing image link.
            document.querySelector("#id__333incgyomf > div > div > span")
        """
        try:
            tweet.find_element(By.CSS_SELECTOR, 'div.css-901oao.css-16my406.r-poiln3.r-bcqeeo.r-qvutc0')
            return True
        except NoSuchElementException:
            return False
        except Exception as ex:
